...
|--------|--------|---------|
| **Зависимости** | TRC-1 → все остальные; RC-3 → RC-4, RC-5, RC-7 | Строгая последовательность итераций 0 → 1 → 2 → 3 → 4; внутри каждой итерации — строгий порядок WP (см. раздел 6.2) |
